...
<body>
	...
	<tr>
	<td align="center">성별 :</td><td><input type="radio" name="gender" value="남자">남자<input type="radio" name="gender" value="여자">여자</td>
	</tr>
	<tr>
	...
	<tr>
	<td align="center"><input type="submit" value="전송"></td><td align="center"><input type="button" value="취소"></td>
	</tr>
	</table>
	</form>
	</div>
